...
class qa_html_theme_layer extends qa_html_theme_base
{
	...
	function head_custom()
	{
		...
		{
			$this->output_raw(
				".wmd-button-bar { margin: 1px; width: 100%; padding: 4px 0; }\n" .
				".wmd-input { width: 100%; height: 250px; border: 1px solid #ccc }\n" .
				".wmd-preview { width: 90%; margin: 22px; padding: 8px; border: 2px dashed #ccc }\n" .
